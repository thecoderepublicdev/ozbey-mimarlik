        ...
        return(
            <form method="POST" onSubmit={handleSubmit} className="grid gap-4">
                <div>
                    ...
                    {touched.fullName && errors.fullName && (<span className="text-red-500 mt-2">{errors.fullName}</span>)}
                </div>
                <div>
                    ...
                    {touched.phone && errors.phone && <span className="text-red-500 mt-2">{errors.phone}</span>}
                </div>
                <div>
                    ...
                    {touched.email && errors.email && (<span className="text-red-500 mt-2">{errors.email}</span>)}
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        {touched.city && errors.city && (<span className="text-red-500 mt-2">{errors.city}</span>)}
                    </div>
                    ...
                    <div>
                        ...
                        {touched.subProvince && errors.subProvince && (<span className="text-red-500 mt-2">{errors.subProvince}</span>)}
                    </div>
                </div>
